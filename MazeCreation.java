...
public class MazeCreation {
    ...
    public MazeCreation(int aDimension) {
        // Initialize
        this(aDimension, aDimension);
    }
    // constructor
    public MazeCreation(int xDimension, int yDimension) {
    ...
    public void updateGrid() {
        ...
        for (int x = 0; x < gridDimensionX; x ++) {
            for (int y = 0; y < gridDimensionY; y ++) {
                ...
                if (x % 4 == 0 || y % 2 == 0) {
                    /*
                      These two if statement make sure that there is front gate
                       at y==0 && x==2
                       and
                       there is end gate at y==gridDimensionY-2 && x==gridDimensionX-1
                     */
                    if(y==0 && x==2 && gate==true) {
                        y++;
                        gate = false;
                    }
